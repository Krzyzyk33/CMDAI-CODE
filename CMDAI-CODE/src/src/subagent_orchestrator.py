...
```json
[
  {{"name": "Agent1", "system_prompt": "You analyze code quality and bugs.", "task": "Find bugs and code quality issues.", "thinking_level": "medium"}},
  {{"name": "Agent2", "system_prompt": "You analyze architecture and design.", "task": "Review project architecture.", "thinking_level": "high"}}
]
```
...
- "thinking_level": requested thinking level ('low', 'medium', 'high', 'ultra', 'extreme')

Example format:
```json
[
  {{"name": "Code Reviewer", "system_prompt": "You are an expert code reviewer. Analyze code for bugs, anti-patterns, and improvements.", "task": "Review all source files for bugs and code quality issues.", "thinking_level": "medium"}},
  {{"name": "Architecture Analyst", "system_prompt": "You are a software architect. Analyze project structure and design patterns.", "task": "Evaluate the project architecture and suggest improvements.", "thinking_level": "high"}}
]
```
